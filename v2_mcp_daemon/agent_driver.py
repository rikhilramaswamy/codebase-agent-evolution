"""
Agent Driver for the Codebase Onboarding Agent (V2).

This module serves as the primary entry point for executing the V2 MCP-enabled 
agent. It initializes the environment and launches the interactive chat loop.
"""
